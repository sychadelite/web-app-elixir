...
class AuthController extends Controller
{
    ...
    public function getDataSambungan()
    {      
        $dataSambungan = DB::table('users')
            ->join('sambungan', 'users.nomor_pelanggan', '=', 'sambungan.nomor_pelanggan')
            ->join('data_sambungan', 'sambungan.nomor_sambungan', '=', 'data_sambungan.nomor_sambungan')
            ->select('data_sambungan.*', 'users.nomor_pelanggan')
            ->where('sambungan.nomor_pelanggan', '=', auth()->user()->nomor_pelanggan)
            ->get();
